...
import com.palliative_care.databinding.ItemCategoryDoctorBinding;
...
public class CategoryDoctorAdapter extends RecyclerView.Adapter<CategoryDoctorAdapter.CategoryViewHolder>
    ...
    public CategoryDoctorAdapter() {
    }

    @NonNull
    @Override
    public CategoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_category_doctor, parent, false);
    ...
    public void onBindViewHolder(@NonNull CategoryViewHolder holder, int position) {
        ...
        holder.binding.edit.setOnClickListener(v -> listener.onSubscribe(model));
    ...
    static class CategoryViewHolder extends RecyclerView.ViewHolder {
        ItemCategoryDoctorBinding binding;

        private CategoryViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = ItemCategoryDoctorBinding.bind(itemView);
        }
    }
