...
import com.palliative_care.databinding.ActivityAddPostBinding;
...
public class AddPostActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        switch (from) {
            case Constants.TYPE_ADD:
                ...
                binding.doctor.setText(doctorName);
    ...
    private void getPostForEdit() {
        ...
        binding.doctor.setText(post.getDoctorName());
    ...
    private void editPostRequest(String file, String fileType) {
        ...
        post.setDoctorName(getText(binding.doctor));
        post.setFile(file);
